...
def attempt_safe(dataset, answer_query, verify_query, modification_query, is_ordered, query):
    """
...
class XBlockDataMixin:
    ...
    modification_query = String(
        ...
        help=_("Optional SQL statements, to be executed after the user-submitted query, but before the verify_query."),
        default="",
        scope=Scope.content,
        multiline_editor=True,
    )
